...
model4=BlobModel(input_features=2,output_features=4,hidden_units=16)
...
optim_fn = torch.optim.SGD(params=model4.parameters(),lr=0.001)
...
MODELNAME= "PYTORCH_MODEL_6:MULTICLASS_NON_LINEAR.pth"
MODELSAVEPATH = MODELPATH/MODELNAME

# save the model state dict
torch.save(model4.state_dict,MODELSAVEPATH)
